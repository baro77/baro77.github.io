...
Domain MX was handled by Proton till December 2025; after that, due to discontent with their refund policy and multi-years customer handling, I switched email to an [Apple's iCloud custom domain](https://support.apple.com/en-us/102540){:target="_blank"}. Of course I still own my pubkey/privkey pair: honestly I never used email encryption (apart automatically with other Proton users), so I'm still evaluating what to do with them... actually, and if not otherwise said, I deprecate their use; but if you still have and will employ my PGP public key, my educated guess is that I'll be able to decrypt, read, answer it :) 
At same time of email provider change I also brushed up my DMARC policy enabling its monitoring by means of [PowerDMARC](https://powerdmarc.com){:target="_blank"}, and I played a bit with [BIMI](https://bimigroup.org){:target="_blank"} (but not certified yet, so just a geeky test).
